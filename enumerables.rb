...
def spiciest_foods(spicy_foods)
  spicy_foods.filter {|food| spicy_food = food[:heat_level]>5}
end
...
def print_spicy_foods(spicy_foods)
  spicy_foods.map do |food| food[:heat_level]="🌶"*food[:heat_level]
...
def get_spicy_food_by_cuisine(spicy_foods, cuisine)
  spicy_foods.find do |food| food =  food[:cuisine]== cuisine
  end
end
...
def print_spiciest_foods(spicy_foods)
  ...
  output=print_spicy_foods(spiciest_foods)
  return output
end
